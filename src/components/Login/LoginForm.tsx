...
const LoginForm = () => {
  ...
  return (
    <div className="w- border-solid border-4 border-red-600 ">
    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 justify-center" onSubmit={handleSubmit(onSubmit)}>
      <div className="mb-4">
